...
- **浏览器 3D 渲染**：当前由隔离的 Three.js 后端负责资源加载、批处理、选择性深度合成、与画面一致的拾取、
  坐标投影、聚焦和截图，产品与美术定义不需要直接依赖 Three.js 对象。
...
- [Requirements and proposals（未实现）](docs/requirements/README.md)
